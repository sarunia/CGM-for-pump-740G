...
{
    0x001Eu,    /* Handle of the DIS service */
    {
        0x0020u, /* Handle of the Manufacturer Name String characteristic */ 
        0x0022u, /* Handle of the Model Number String characteristic */ 
        0x0024u, /* Handle of the Serial Number String characteristic */ 
        0x0026u, /* Handle of the Hardware Revision String characteristic */ 
        0x0028u, /* Handle of the Firmware Revision String characteristic */ 
        0x002Au, /* Handle of the Software Revision String characteristic */ 
        0x002Cu, /* Handle of the System ID characteristic */ 
        CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the IEEE 11073-20601 Regulatory Certification Data List characteristic */ 
        0x002Eu, /* Handle of the PnP ID characteristic */ 
    },
};
