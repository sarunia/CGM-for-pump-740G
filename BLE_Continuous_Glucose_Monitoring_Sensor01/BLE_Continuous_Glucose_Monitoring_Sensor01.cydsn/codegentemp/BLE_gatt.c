    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0xB1u] = {
    /* Device Name */
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0001u, (void *)&cyBle_attValues[173] }, /* Bond Management Control Point */
    { 0x0003u, (void *)&cyBle_attValues[174] }, /* Bond Management Features */
};

const CYBLE_GATTS_DB_T cyBle_gattDB[0x50u] = {
    ...
    { 0x0011u, 0x2AA8u /* CGM Feature                         */, 0x01020001u /* rd     */, 0x0011u, {{0x0006u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x0012u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0013u, {{0x2AA9u, NULL}}                           },
    { 0x0013u, 0x2AA9u /* CGM Status                          */, 0x01020001u /* rd     */, 0x0013u, {{0x0005u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0014u, 0x2803u /* Characteristic                      */, 0x000A0001u /* rd,wr  */, 0x0015u, {{0x2AAAu, NULL}}                           },
    { 0x0015u, 0x2AAAu /* CGM Session Start Time              */, 0x010A0101u /* rd,wr  */, 0x0015u, {{0x0009u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0016u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0017u, {{0x2AABu, NULL}}                           },
    { 0x0017u, 0x2AABu /* CGM Session Run Time                */, 0x01020001u /* rd     */, 0x0017u, {{0x0002u, (void *)&cyBle_attValuesLen[10]}} },
    { 0x0018u, 0x2803u /* Characteristic                      */, 0x00280001u /* wr,ind */, 0x001Au, {{0x2A52u, NULL}}                           },
    { 0x0019u, 0x2A52u /* Record Access Control Point         */, 0x01280100u /* wr,ind */, 0x001Au, {{0x0003u, (void *)&cyBle_attValuesLen[11]}} },
    ...
    { 0x001Cu, 0x2AACu /* CGM Specific Ops Control Point      */, 0x01280100u /* wr,ind */, 0x001Du, {{0x000Fu, (void *)&cyBle_attValuesLen[13]}} },
    { 0x001Du, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x001Du, {{0x0002u, (void *)&cyBle_attValuesLen[14]}} },
    ...
    { 0x0020u, 0x2A29u /* Manufacturer Name String            */, 0x01020001u /* rd     */, 0x0020u, {{0x0009u, (void *)&cyBle_attValuesLen[15]}} },
    { 0x0021u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0022u, {{0x2A24u, NULL}}                           },
    { 0x0022u, 0x2A24u /* Model Number String                 */, 0x01020001u /* rd     */, 0x0022u, {{0x000Au, (void *)&cyBle_attValuesLen[16]}} },
    { 0x0023u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0024u, {{0x2A25u, NULL}}                           },
    { 0x0024u, 0x2A25u /* Serial Number String                */, 0x01020001u /* rd     */, 0x0024u, {{0x000Au, (void *)&cyBle_attValuesLen[17]}} },
    { 0x0025u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0026u, {{0x2A27u, NULL}}                           },
    { 0x0026u, 0x2A27u /* Hardware Revision String            */, 0x01020001u /* rd     */, 0x0026u, {{0x0005u, (void *)&cyBle_attValuesLen[18]}} },
    { 0x0027u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0028u, {{0x2A26u, NULL}}                           },
    { 0x0028u, 0x2A26u /* Firmware Revision String            */, 0x01020001u /* rd     */, 0x0028u, {{0x0004u, (void *)&cyBle_attValuesLen[19]}} },
    { 0x0029u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x002Au, {{0x2A28u, NULL}}                           },
    { 0x002Au, 0x2A28u /* Software Revision String            */, 0x01020001u /* rd     */, 0x002Au, {{0x000Du, (void *)&cyBle_attValuesLen[20]}} },
    { 0x002Bu, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x002Cu, {{0x2A23u, NULL}}                           },
    { 0x002Cu, 0x2A23u /* System ID                           */, 0x01020001u /* rd     */, 0x002Cu, {{0x0008u, (void *)&cyBle_attValuesLen[21]}} },
    { 0x002Du, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x002Eu, {{0x2A50u, NULL}}                           },
    { 0x002Eu, 0x2A50u /* PnP ID                              */, 0x01020001u /* rd     */, 0x002Eu, {{0x0007u, (void *)&cyBle_attValuesLen[22]}} },
    ...
    { 0x0031u, 0x2A19u /* Battery Level                       */, 0x01020001u /* rd     */, 0x0033u, {{0x0001u, (void *)&cyBle_attValuesLen[23]}} },
    { 0x0032u, 0x2904u /* Characteristic Presentation Format  */, 0x01020001u /* rd     */, 0x0032u, {{0x0007u, (void *)&cyBle_attValuesLen[24]}} },
    { 0x0033u, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x0033u, {{0x0002u, (void *)&cyBle_attValuesLen[25]}} },
    ...
    { 0x0037u, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x0037u, {{0x0002u, (void *)&cyBle_attValuesLen[29]}} },
    { 0x0038u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0039u, {{0x0010u, (void *)&cyBle_attValuesLen[30]}} },
    { 0x0039u, 0x5221u /* DE3E5221-1308-439C-A13A-884DDC387CA */, 0x09020001u /* rd     */, 0x0039u, {{0x0001u, (void *)&cyBle_attValuesLen[31]}} },
    { 0x003Au, 0x2803u /* Characteristic                      */, 0x00080001u /* wr     */, 0x003Bu, {{0x0010u, (void *)&cyBle_attValuesLen[32]}} },
    { 0x003Bu, 0x039Eu /* 8484039E-97D3-40C0-BB55-C70C17BADAE */, 0x09080100u /* wr     */, 0x003Bu, {{0x0001u, (void *)&cyBle_attValuesLen[33]}} },
    { 0x003Cu, 0x2800u /* Primary service                     */, 0x00000001u /*        */, 0x0041u, {{0xFE82u, NULL}}                           },
    { 0x003Du, 0x2802u /* Included service                    */, 0x00000001u /*        */, 0x003Du, {{0x004Cu, NULL}}                           },
    { 0x003Eu, 0x2803u /* Characteristic                      */, 0x00180001u /* wr,ntf */, 0x0041u, {{0x0010u, (void *)&cyBle_attValuesLen[34]}} },
    { 0x003Fu, 0xFE82u /* 0000FE82-0000-1000-0000-00913259132 */, 0x09180100u /* wr,ntf */, 0x0041u, {{0x0001u, (void *)&cyBle_attValuesLen[35]}} },
    { 0x0040u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd     */, 0x0040u, {{0x000Au, (void *)&cyBle_attValuesLen[36]}} },
    { 0x0041u, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x0041u, {{0x0002u, (void *)&cyBle_attValuesLen[37]}} },
    { 0x0042u, 0x2800u /* Primary service                     */, 0x08000001u /*        */, 0x004Bu, {{0x0010u, (void *)&cyBle_attValuesLen[38]}} },
    { 0x0043u, 0x2803u /* Characteristic                      */, 0x00280001u /* wr,ind */, 0x0045u, {{0x2A52u, NULL}}                           },
    { 0x0044u, 0x2A52u /* Record Access Control Point         */, 0x01280100u /* wr,ind */, 0x0045u, {{0x0003u, (void *)&cyBle_attValuesLen[39]}} },
    { 0x0045u, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x0045u, {{0x0002u, (void *)&cyBle_attValuesLen[40]}} },
    { 0x0046u, 0x2803u /* Characteristic                      */, 0x00280001u /* wr,ind */, 0x0048u, {{0x0010u, (void *)&cyBle_attValuesLen[41]}} },
    { 0x0047u, 0x0360u /* 00000360-0000-1000-0000-00913259132 */, 0x09280100u /* wr,ind */, 0x0048u, {{0x0001u, (void *)&cyBle_attValuesLen[42]}} },
    { 0x0048u, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x0048u, {{0x0002u, (void *)&cyBle_attValuesLen[43]}} },
    { 0x0049u, 0x2803u /* Characteristic                      */, 0x00000001u /*        */, 0x004Bu, {{0x0010u, (void *)&cyBle_attValuesLen[44]}} },
    { 0x004Au, 0x0350u /* 00000350-0000-1000-0000-00913259132 */, 0x09000000u /*        */, 0x004Bu, {{0x0001u, (void *)&cyBle_attValuesLen[45]}} },
    { 0x004Bu, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x004Bu, {{0x0002u, (void *)&cyBle_attValuesLen[46]}} },
    { 0x004Cu, 0x2800u /* Primary service                     */, 0x00000001u /*        */, 0x0050u, {{0x181Eu, NULL}}                           },
    { 0x004Du, 0x2803u /* Characteristic                      */, 0x00080001u /* wr     */, 0x004Eu, {{0x2AA4u, NULL}}                           },
    { 0x004Eu, 0x2AA4u /* Bond Management Control Point       */, 0x01080100u /* wr     */, 0x004Eu, {{0x0001u, (void *)&cyBle_attValuesLen[47]}} },
    { 0x004Fu, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0050u, {{0x2AA5u, NULL}}                           },
    { 0x0050u, 0x2AA5u /* Bond Management Features            */, 0x01020001u /* rd     */, 0x0050u, {{0x0003u, (void *)&cyBle_attValuesLen[48]}} },
};
