...
#define CYBLE_FE82_CUSTOM_CHARACTERISTIC_DECL_HANDLE   (0x003Eu) /* Handle of 0000FE82-0000-1000-0000-009132591325 characteristic declaration */
#define CYBLE_FE82_CUSTOM_CHARACTERISTIC_CHAR_HANDLE   (0x003Fu) /* Handle of 0000FE82-0000-1000-0000-009132591325 characteristic */
#define CYBLE_FE82_CUSTOM_CHARACTERISTIC_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0040u) /* Handle of Characteristic User Description descriptor */
#define CYBLE_FE82_CUSTOM_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0041u) /* Handle of Client Characteristic Configuration descriptor */

#define CYBLE_CUSTOM_SERVICE_2_SERVICE_HANDLE   (0x0042u) /* Handle of 00000300-0000-1000-0000-009132591325 service */
#define CYBLE_CUSTOM_SERVICE_2_RECORD_ACCESS_CONTROL_POINT_DECL_HANDLE   (0x0043u) /* Handle of Record Access Control Point characteristic declaration */
#define CYBLE_CUSTOM_SERVICE_2_RECORD_ACCESS_CONTROL_POINT_CHAR_HANDLE   (0x0044u) /* Handle of Record Access Control Point characteristic */
#define CYBLE_CUSTOM_SERVICE_2_RECORD_ACCESS_CONTROL_POINT_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0045u) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_CUSTOM_SERVICE_2_CUSTOM_CHARACTERISTIC_DECL_HANDLE   (0x0046u) /* Handle of 00000360-0000-1000-0000-009132591325 characteristic declaration */
#define CYBLE_CUSTOM_SERVICE_2_CUSTOM_CHARACTERISTIC_CHAR_HANDLE   (0x0047u) /* Handle of 00000360-0000-1000-0000-009132591325 characteristic */
#define CYBLE_CUSTOM_SERVICE_2_CUSTOM_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0048u) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_CUSTOM_SERVICE_2_CUSTOM_CHARACTERISTIC_2_DECL_HANDLE   (0x0049u) /* Handle of 00000350-0000-1000-0000-009132591325 characteristic declaration */
#define CYBLE_CUSTOM_SERVICE_2_CUSTOM_CHARACTERISTIC_2_CHAR_HANDLE   (0x004Au) /* Handle of 00000350-0000-1000-0000-009132591325 characteristic */
#define CYBLE_CUSTOM_SERVICE_2_CUSTOM_CHARACTERISTIC_2_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x004Bu) /* Handle of Client Characteristic Configuration descriptor */
